    ...
    var s,
        ...
        ur = (a = "alert", c = "." + (l = "bs.alert"), h = (s = t).fn[a], u = {
            ...
            return e.next = function() {
                ...
                if (t === Q ? (n = q, i = z, r = U) : (n = Y, i = X, r = G), l && $(l).hasClass(K))
                    this._isSliding = !1;
                ...
                return this.each(function() {
                    ...
                    if (n || (n = new t(this, i), $(this).data(R, n)), "number" == typeof e)
                        n.to(e);
            ...
            return e.toggle = function(t) {
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    }), i && hr.reflow(this._backdrop), gt(this._backdrop).addClass(Dt), !t)
                        return;
                    if (!i)
                        return void t();
        ...
        dr = (te = "popover", ne = "." + (ee = "bs.popover"), ie = (Jt = t).fn[te], re = "bs-popover", oe = new RegExp("(^|\\s)" + re + "\\S+", "g"), se = r({}, ur.Default, {
            ...
            var i = {
                ...
                assert: function(t, e, n) {
                    if (e)
                        throw void 0 === !t && t.css("border", "1px solid red"), console.error(n, t), n
                },
                describe: function(t) {
